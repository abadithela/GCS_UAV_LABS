...
/**
 * @author dcollins
 * @version $Id: AnalyticSurfaceDemo.java 12810 2009-11-19 19:03:49Z dcollins $
 */
public class AnalyticSurfaceDemo extends ApplicationTemplate
{
    public static class AppFrame extends ApplicationTemplate.AppFrame
    {
        ...
        protected void initAnalyticSurfaceLayer()
        {
            ...
            createPrecipitationSurface(HUE_BLUE, HUE_RED, this.analyticSurfaceLayer);
        }
    }
    ...
    protected static void createPrecipitationSurface(double minHue, double maxHue, RenderableLayer outLayer)
    {
        ...
        AnalyticSurfaceLegend legend = AnalyticSurfaceLegend.fromColorGradient(extremes[0], extremes[1], minHue, maxHue,
