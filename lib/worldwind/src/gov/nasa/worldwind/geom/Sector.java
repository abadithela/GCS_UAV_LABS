 ...
 *
 * @author Tom Gaskins
 * @version $Id: Sector.java 12830 2009-11-26 15:39:49Z patrickmurris $
 * @see Angle
 */
public class Sector implements Cacheable, Comparable<Sector>, Iterable<LatLon>
{
    ...
    /**
     * returns a list of Lat/Lon coordinates of a Sector's corners.
     *
     * @return a LatLon array of four corners
     */
