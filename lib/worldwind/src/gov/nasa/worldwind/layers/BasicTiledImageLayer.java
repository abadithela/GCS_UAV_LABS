...
/**
 * @author tag
 * @version $Id: BasicTiledImageLayer.java 12778 2009-11-10 01:20:37Z tgaskins $
 */
public class BasicTiledImageLayer extends TiledImageLayer implements BulkRetrievable
{
    ...
    {
        BasicTiledImageLayerBulkDownloader thread = new BasicTiledImageLayerBulkDownloader(this, sector, resolution,
