 ...
 *
 * @author tag
 * @version $Id: PlaceNameLayerBulkDownloader.java 12546 2009-09-03 05:36:57Z tgaskins $
 */
public class PlaceNameLayerBulkDownloader extends BulkRetrievalThread
{
     ...
     *
     * @throws IllegalArgumentException if either the layer, the sector or file store are null, or the
