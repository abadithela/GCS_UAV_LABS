...
/**
 * @author Paul Collins
 * @version $Id: PlaceNameService.java 10757 2009-05-01 18:06:04Z jparsons $
 */
public class PlaceNameService
{
    ...
    public final Extent getExtent(DrawContext dc)
    {
        ...
        if (this.extent == null || this.extentVerticalExaggeration != dc.getVerticalExaggeration())
        {
            ...
            this.extent = dc.getGlobe().computeBoundingCylinder(this.extentVerticalExaggeration, this.maskingSector);
        }
