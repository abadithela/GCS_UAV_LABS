 ...
 * @version $Id: AnnotationAttributes.java 12654 2009-09-26 00:15:54Z patrickmurris $
...
public class AnnotationAttributes implements Restorable
{
    ...
    /**
     * Get the text alignement. Can be one of {@link AVKey#LEFT} (default), {@link AVKey#CENTER}
     * or {@link AVKey#RIGHT}.
    ...
    /**
     * Set the text alignement. Can be one of {@link AVKey#LEFT} (default), {@link AVKey#CENTER}
     * or {@link AVKey#RIGHT}. Set to <code>null</code> to use the default value.
    ...
    public void setDistanceMinOpacity(double opacity)
    {
     ...
     /**
      * Get the effect used to decorate the text. Can be one of {@link AVKey#TEXT_EFFECT_SHADOW},
      * {@link AVKey#TEXT_EFFECT_OUTLINE} or {@link AVKey#TEXT_EFFECT_NONE} (default).
    ...
    /**
     * Set the effect used to decorate the text. Can be one of {@link AVKey#TEXT_EFFECT_SHADOW},
     * {@link AVKey#TEXT_EFFECT_OUTLINE} or {@link AVKey#TEXT_EFFECT_NONE} (default). Set to
                                          ...
                                          AnnotationAttributes dest)
    {
        ...
        // Legacy text align state as integer
        Integer textAlignState = restorableSupport.getStateValueAsInteger(context, "textAlign");
        if (textAlignState != null)
        {
            dest.setTextAlign(textAlignState == 0 ? AVKey.LEFT : textAlignState == 1 ? AVKey.CENTER : AVKey.RIGHT);
        }
        else
        {
            // String text align state
            String textAlignStringState = restorableSupport.getStateValueAsString(context, "textAlign");
            if (textAlignStringState != null)
                dest.setTextAlign(textAlignStringState);
        }
