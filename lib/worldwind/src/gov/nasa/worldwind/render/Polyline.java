...
/**
 * @author tag
 * @version $Id: Polyline.java 12827 2009-11-25 16:49:42Z patrickmurris $
 */
public class Polyline implements Renderable, Movable, Restorable
{
    ...
    {
        return this.globe != null ? this.measurer.getLength(this.globe) : 0;
    }
    ...
    public void render(DrawContext dc)
    {
        ...
        if (this.currentSpans == null || (this.followTerrain && this.geomGenFrameTime != dc.getFrameTimeStamp())
