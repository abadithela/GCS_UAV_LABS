...
/**
 * @author tag
 * @version $Id: Polygon.java 12584 2009-09-14 19:25:59Z dcollins $
 */
public class Polygon extends AbstractAirspace
{
                                          ...
                                          Vec4[] points, Boolean[] edgeFlagArray, Matrix[] transform)
    {
        ...
        // Compute the cartesian points for each location, and compute the average of these points.
        ...
        for (int i = 0; i < locationCount; i++)
        {
            ...
            centerPoint = (centerPoint == null) ? points[i] : points[i].add3(centerPoint);            
        }
        //noinspection ConstantConditions
        centerPoint = centerPoint.divide3(locationCount);
