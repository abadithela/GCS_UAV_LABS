...
/**
 * @author dcollins
 * @version $Id: OrbitViewInputHandler.java 12749 2009-10-27 00:11:45Z dcollins $
 */
public class OrbitViewInputHandler extends BasicViewInputHandler
{
    ...
    {
        Angle newHeading = BasicOrbitView.normalizedPitch(pitch);
        return BasicOrbitViewLimits.limitPitch(newHeading, limits);
    }
    ...
    public void addHeadingPitchAnimator(Angle beginHeading, Angle endHeading, Angle beginPitch, Angle endPitch)
    {
        ...
        CompoundAnimator headingPitchAnimator = ViewUtil.createHeadingPitchAnimator(this.getView(),
